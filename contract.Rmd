...
- [ ] `r advdate(dayone, 1, topic)`
  - Finish Lab 1 by `r advdate(dayone, 1, assignment=startweek)`
- [ ] `r advdate(dayone, 2, topic)`
  - Finish Lab 2 by `r advdate(dayone, 2, assignment="f")`
  - Propose your contract to Mason by `r advdate(dayone, 2, assignment=startweek)`
- [ ]  `r advdate(dayone, 3, topic)`
  - Finish Lab 3  by `r advdate(dayone, 3, assignment=startweek)`
  - Finish portfolio piece 1 by `r advdate(dayone, 3, assignment=startweek)`
- [ ] `r advdate(dayone, 4, topic)`
  - Finish Lab 4  by `r advdate(dayone, 4, assignment=startweek)`
- [ ] `r advdate(dayone, 5, topic)`
  - Finish Lab 5  by `r advdate(dayone, 5, assignment=startweek)`
  - Finish portfolio piece 2 by `r advdate(dayone, 5, assignment=startweek)`
- [ ] `r advdate(dayone, 6, topic)`
  - Finish Lab 6 by `r advdate(dayone, 6, assignment=startweek)`
  - Schedule a check-in with Mason by `r advdate(dayone, 6, assignment=startweek)`
- [ ] `r advdate(dayone, 7, topic)`
  - Finish Lab 7 by `r advdate(dayone, 7, assignment=startweek)`
  - Finish portfolio piece 3 by `r advdate(dayone, 7, assignment=startweek)`
- [ ] `r advdate(dayone, 8, topic)`
  - Finish Lab 8 by `r advdate(dayone, 8, assignment=startweek)`
- [ ] `r advdate(dayone, 9, topic)`
  - Finish Lab 9 by `r advdate(dayone, 9, assignment=startweek)`
  - Finish portfolio piece 4 by `r advdate(dayone, 9, assignment=startweek)`
- [ ] `r advdate(dayone, 10, topic)`
  - Finish Lab 10 by `r advdate(dayone, 10, assignment=startweek)`
- [ ] `r advdate(dayone, 11, topic)`
  `r if(params$labs>=11) paste0(" - Finish Lab 11 by ",advdate(dayone, 11, assignment=startweek))`
  - Finish portfolio piece 5 by `r advdate(dayone, 11, assignment=startweek)`
- [ ] `r advdate(dayone, 12, topic)`
  `r if(params$labs>=12) paste0(" - Finish Lab 12 by ",advdate(dayone, 12, assignment=startweek))`
  - Finish portfolio piece 6 by `r advdate(dayone, 12, assignment=startweek)`
- [ ] `r advdate(dayone, 13, topic)`
  `r if(params$labs>=13) paste0(" - Finish Lab 13 by ",advdate(dayone, 13, assignment=startweek))`
  - Finish portfolio pieces 7 and 8 by `r advdate(dayone, 13, assignment=startweek)`
- [ ] `r advdate(dayone, 14, topic)`
  - Finish portfolio piece 9 by `r advdate(dayone, 14, assignment=startweek)`
- [ ] `r advdate(dayone, 15, topic)`
  - Finish portfolio piece 10 by `r advdate(dayone, 15, assignment=startweek)`
- [ ] Portfolio completion and end-of-semester presentation
  - Due on `r advdate(dayone, 15, assignment=startweek)`
